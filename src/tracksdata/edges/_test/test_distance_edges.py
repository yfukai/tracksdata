...
def test_distance_edges_init_default_params() -> None:
    ...
    operator = DistanceEdgesOperator(distance_threshold=10.0, n_neighbors=3)
...
def test_distance_edges_init_custom_params() -> None:
    ...
    operator = DistanceEdgesOperator(
        distance_threshold=5.0, n_neighbors=2, feature_keys=["x", "y"], show_progress=False
    )
...
def test_distance_edges_add_edges_empty_graph() -> None:
    ...
    operator = DistanceEdgesOperator(distance_threshold=10.0, n_neighbors=3, show_progress=False)
...
def test_distance_edges_add_edges_2d_coordinates() -> None:
    ...
    operator = DistanceEdgesOperator(distance_threshold=3.0, n_neighbors=2, show_progress=False)
...
def test_distance_edges_add_edges_distance_threshold() -> None:
    ...
    operator = DistanceEdgesOperator(distance_threshold=1.0, n_neighbors=2, show_progress=False)  # Very small threshold
...
def test_distance_edges_add_edges_multiple_timepoints() -> None:
    ...
    operator = DistanceEdgesOperator(distance_threshold=5.0, n_neighbors=2, show_progress=False)
